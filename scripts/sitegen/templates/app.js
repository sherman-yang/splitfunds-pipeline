...
const tableConfigs = {
  classa: {
    ...
    columns: [
      ...
      { key: 'nav_self', label: 'Class NAV', type: 'number', visible: true },
      { key: 'discount_to_nav', label: 'Discount to NAV', type: 'percent', visible: true },
  ...
  preferred: {
    ...
    columns: [
      ...
      { key: 'unit_nav', label: 'Unit NAV', type: 'number', visible: true },
      { key: 'coverage', label: 'Coverage', type: 'number', visible: true },
      { key: 'nav_self', label: 'Pref NAV', type: 'number', visible: true },
      { key: 'discount_to_nav', label: 'Discount to NAV', type: 'percent', visible: true },
      { key: 'annualized_discount_to_nav', label: 'Annualized NAV Discount', type: 'percent', visible: false },
